########################################################################
### COMPUTING CROSS-CORRELATIONS AND STRONGEST NEGATIVE CORRELATIONS ###
########################################################################

# This script computes cross-correlations from daily/monthly climatology (clim) datasets.
...
CrossCorr_clim <- function(file=file, file2=file2, file3=file3,
